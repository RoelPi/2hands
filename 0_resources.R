...
t <- theme(plot.title = element_text(face="bold"),
           axis.text.x = element_text(size=14,color='#000000',angle=45,hjust=1),
           axis.text.y = element_text(size=14,color='#000000'),
           axis.title.x = element_text(face="bold", size=14,color='#000000'),
           axis.title.y = element_text(face="bold", size=14,color='#000000'),
           ...
           legend.title = element_text(face='bold',size=14,color='#000000'),
           legend.box.background = element_rect(fill='#ffffff', color='#ffffff', size=1.5),
           strip.text = element_text(size=14,color='#000000', face='bold'),
